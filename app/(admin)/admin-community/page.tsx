...
import { IoImageOutline, IoTrashOutline, IoAddOutline, IoSettingsOutline, IoCreateOutline, IoPencilOutline, IoChevronUpOutline, IoChevronDownOutline, IoHappyOutline } from 'react-icons/io5';
...
function AdminCommunityContent() {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      await Promise.all([loadPhotos(), loadPointSettings(), loadTemplates(), loadActiveTemplate(), loadEmojiPacks()]);
    };
    checkAuth();
  }, [router]);
